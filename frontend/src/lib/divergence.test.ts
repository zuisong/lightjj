...
import { classify, refineRebaseKind, buildKeepPlan, computeRefinedKind, findCrossColumnMerge, type DivergenceGroup, type RefinedKind } from './divergence'
...
// ── Refined classification (folded in from divergence-refined.test.ts) ──────
// computeRefinedKind decision table + findCrossColumnMerge. These lock the
// post-tree-delta taxonomy that DivergencePanel renders.
